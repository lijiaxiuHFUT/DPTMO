...
class DistilBert(nn.Module):
    def __init__(self, joint_space_size, dataset):
        ...
        self.fc_out3 = nn.Linear(768, joint_space_size)
    ...
    def forward(self, queries, wordlens):
        ...
        for query, word_len in zip(queries, wordlens):  # each sample (several sentences) in a batch (of videos)
            ...
            if self.aggregation == "cls":
                ...
                out_iou_fusion = self.fc_out3(query)
            elif self.aggregation == "avg":
                bert_encoding = self.encoder_layer(bert_encoding)
            ...
            sent_feat_iou_fusion.append(out_iou_fusion)
        return sent_feat, sent_feat_iou, sent_feat_iou_fusion
